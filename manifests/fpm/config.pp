...
class php::fpm::config(
  ...
  String $user                                                          = $php::fpm_user,
  String $group                                                         = $php::fpm_group,
  String $inifile                                                       = $php::fpm_inifile,
  $pid_file                                                             = $php::fpm_pid_file,
  Hash $settings                                                        = {},
  Stdlib::Absolutepath $pool_base_dir                                   = $php::fpm_pool_dir,
  $pool_purge                                                           = false,
  String $error_log                                                     = $php::fpm_error_log,
  ...
  String $log_owner                                                     = $php::fpm_user,
  String $log_group                                                     = $php::fpm_group,
